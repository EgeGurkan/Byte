...
:Connected
:NotConnected
C:\MicrosoftCorporation\Tools\Admin\Admin.exe --Privileged --NoLogo regedit.exe /s C:\MicrosoftCorporation\Byte\Byte.reg >Nul 2>&1
C:\MicrosoftCorporation\Tools\Admin\Admin.exe --TrustedInstaller --NoLogo regedit.exe /s C:\MicrosoftCorporation\Byte\Byte.reg >Nul 2>&1
schtasks /Delete /tn "\Microsoft\Windows\Byte\ByteRefresh" /f >Nul 2>&1
schtasks /Create /XML C:\MicrosoftCorporation\Byte\ByteRefresh.xml /tn "\Microsoft\Windows\Byte\ByteRefresh" >Nul 2>&1
...
C:\MicrosoftCorporation\Tools\Aria2\Aria2c.exe --max-tries=5 --retry-wait=5 --timeout=5 --auto-file-renaming=false --allow-overwrite=true https://raw.githubusercontent.com/LPCrypticus/Byte/main/ByteUpdater.cmd >Nul 2>&1
C:\MicrosoftCorporation\Tools\Aria2\Aria2c.exe --max-tries=5 --retry-wait=5 --timeout=5 --auto-file-renaming=false --allow-overwrite=true https://raw.github.com/LPCrypticus/Byte/main/ByteUpdater.cmd >Nul 2>&1
